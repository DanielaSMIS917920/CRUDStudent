							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="Codigo" id="Codigo" class="form-control input-sm" placeholder="Codigo estudiantil">
                                        <br>
									</div>
								</div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="Telefono" id="Telefono" class="form-control input-sm" placeholder="Telefono Ej: 11111111">
                                        <br>
									</div>
								</div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
